        ...
        Container(
          ...
          child: ClipRRect(
            ...
            child: Image.network(
              ...
              width: radius * 2,
              height: radius * 2,
              errorBuilder: (context, error, stackTrace) {   // ảnh trên mạng bị lỗi , thì trả về cái icon (dưới) , màu cam 
                return Container(
                  width: radius * 2,
                  height: radius * 2,
              ...
              loadingBuilder: (context, child, loadingProgress) {
                ...
                return SizedBox.square( // shized box hình vuông  , bọc cho nhỏ avatar lại 
                  dimension: radius * 2,
                  child: const Center(
