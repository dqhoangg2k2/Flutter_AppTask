...
class TdElevatedButton extends StatelessWidget {
  TdElevatedButton({
    ...
    this.isDisable = false,  // vô hiệu hóa code 
    Color? splashColor,
  ...
  Widget build(BuildContext context) {
    return Material(
      borderRadius: borderRadius,
        // onTap: isDisable == true ? null : onPressed,   //  true là null ko bấm đc , flase bấm đc  
      surfaceTintColor: Colors.transparent, //  true là null ko bấm đc , flase bấm đc      // vô hiệu hóa code
